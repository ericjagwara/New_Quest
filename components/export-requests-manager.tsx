...
export function ExportRequestsManager({ user }: ExportRequestsManagerProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="bg-white/80 backdrop-blur-sm shadow-lg border-emerald-100">
        ...
        <CardContent>
          {pendingRequests.length === 0 ? (
            <div className="text-center py-8 text-gray-500">No pending export requests</div>
          ) : (
              ...
              <Table>
                ...
                <TableBody>
                  {pendingRequests.map((request) => (
                    <TableRow key={request.id} className="hover:bg-emerald-50/50">
                      <TableCell>
                        <div>
                      ...
                      <TableCell className="text-gray-700">{request.data_type}</TableCell>
      ...
      <Card className="bg-white/80 backdrop-blur-sm shadow-lg border-emerald-100">
        <CardHeader>
          <CardTitle className="text-emerald-800">Recent Processed Requests</CardTitle>
        </CardHeader>
        <CardContent>
